...
for combo in all_combinations:
    ...
    if sys_contract is not None:
        ...
        # If needed, write the successful designs to contract files:
        # write_contracts_to_file([sys_contract], ["contract_"+str(count)], 
        #                         "data/successful_design_" + str(count) + ".json")
        count += 1
...
with open("data/design_error_log.txt", "w") as f:
